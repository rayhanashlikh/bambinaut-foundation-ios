...
let seedIngredients: [(name: String, minMonths: Int, maxMonths: Int, allergen: String?, nutritions: [String], weightSuitability: Int, description: String)] = [
    ...
    ("Strawberry", 6, 12, nil, ["Vitamin C", "Antioxidants"], 0, "Tender fruit rich in vitamins."),
    ("Mushroom", 8, 12, nil, ["Fiber", "Vitamin D", "B Vitamins"], 0, "Savory fungi packed with nutrients and flavor."),
    ("Tomato", 6, 12, nil, ["Vitamin C", "Potassium", "Antioxidants"], 0, "Versatile fruit packed with nutrients and flavor."),
    ("Tubers", 6, 12, nil, ["Carbohydrates", "Fiber", "Vitamins"], 0, "Hearty root vegetables that are filling."),
    ("Orange", 6, 12, nil, ["Vitamin C", "Fiber", "Folate"], 0, "Nutritious fruit that is sweet and tangy."),
    ("Grape", 6, 12, nil, ["Vitamin C", "Antioxidants", "Fiber"], 0, "Sweet fruit known for its health benefits."),
    ("Octopus", 10, 12, "Seafood", ["Protein", "Omega-3 Fatty Acids", "Selenium"], 1, "Tender meat rich in flavor and nutrients."),
    ("Rice", 6, 12, nil, ["Carbohydrates", "B Vitamins", "Iron"], 0, "Tender, flavorful grain rich in nutrients."),
    ("Cabbage", 8, 12, nil, ["Vitamins K", "C", "Fiber"], -1, "Versatile vegetable that is nutritious and filling."),
    ("Asparagus", 8, 12, nil, ["Vitamins A", "K", "Folate", "C", "Potassium", "Phosphorus", "Vitamin E"], 0, "Crunchy vegetable often used in salads and stir-fries."),
    ("Cow Milk", 12, 12, "Dairy", ["Calcium", "Protein", "Vitamin D"], 0, "Nutrient-rich liquid that is versatile.")
]
